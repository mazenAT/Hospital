   ...
   /* private CheckOperations() {
    ...
    public void showOperation(){
        try {
           ...
           System.out.print(p.getOperation().getTime());
            jTextField1.setText(p.getOperation().getTime());
            jTextField2.setText(p.getOperation().getType());
            jTextField3.setText(p.getOperation().getAssignedDoctor());
            jTextField4.setText(p.getOperation().getAssignedNurse());
        } catch (Exception ex) {
            System.out.print(ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel4.setText(" Assigned Nurse :");
