 ...
 * @author hmoo_
 */
public class RegisterChemist extends javax.swing.JFrame {

    /**
     * Creates new form RegisterAccountant
     */
    public RegisterChemist() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("  Register Chemist");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterChemist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterChemist().setVisible(true);
            }
        });
    }
